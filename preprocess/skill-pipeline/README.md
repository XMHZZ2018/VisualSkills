...
| **Where the output goes** | `skills/<domain>-knowledge-{text,multimodal}-stage1/` | `skills/<domain>-knowledge-{text,multimodal}-stage2/` (mm-stage2 = mm-stage1 + appended `## UI Reference` sections) |
