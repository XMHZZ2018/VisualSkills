...
#
# Produces:
#   skills/<domain>-knowledge-text-stage1/
#   skills/<domain>-knowledge-multimodal-stage1/
...
Options:
  ...
  --phase N                        run only phase N (1..6); default flow is 1-5.
                                   Phase 6 (text-stage1 from multimodal-stage1) is
...
Per-phase parallelism is configured in the YAML config:
  ...
  parallel:
    ...
    phase_6: 4     # text-stage1 from multimodal-stage1 (Claude calls — optional phase)
