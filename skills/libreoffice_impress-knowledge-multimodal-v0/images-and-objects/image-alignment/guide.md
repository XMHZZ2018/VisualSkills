...
Read the screenshot `fig01.png` in this directory — you will see the Properties sidebar with the Position and Size panel expanded, showing Align icon buttons at the bottom.
...
Read the screenshot `fig02.png` in this directory — you will see the Options - LibreOffice Impress - Grid dialog with snap, resolution, and subdivision settings.
...
Read the screenshot `fig03.png` in this directory — you will see the Position and Size dialog with X/Y position fields, width/height fields, and the Keep ratio checkbox.
