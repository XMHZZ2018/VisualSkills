...
Read the screenshot `fig01.png` in this directory — you will see connectors linking shapes via glue points, showing right-angle and curved connector types.
...
Read the screenshot `fig02.png` in this directory — you will see the Connector dialog with Type, Line Skew, and Line Spacing settings.
...
Read the screenshot `fig03.png` in this directory — you will see three grouped shapes (rectangle, ellipse, diamond) selected as a single unit with shared selection handles.
