...
Go to **Colors > Levels** from the menu bar. The "Adjust Color Levels" dialog appears with:
...
Go to **Colors > Color Balance** from the menu bar. The dialog contains:
...
The Neon filter detects edges and renders them as bright, glowing colored lines on a black background — similar to neon signs. The result should be a dramatic transformation: completely black background with vivid colored edge lines (cyan, magenta, yellow, green, white).
...
3. Enable **Preview** to check the result — edges should be bright and vivid, not faint.
4. Click **OK** to apply.
