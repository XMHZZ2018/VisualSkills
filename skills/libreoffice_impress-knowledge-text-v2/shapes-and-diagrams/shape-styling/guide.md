...
Visual reference: examples of the six area fill types: None, Color, Gradient, Hatching, Bitmap, and Pattern.
...
Visual reference: the Area dialog on the Color page, showing the palette grid, RGB and Hex values, and Custom Palette Add/Delete buttons.
...
Visual reference: the Line dialog showing Line Properties, Corner and Cap Styles, Arrow Styles, and a line preview.
