...
Visual reference: the Hyperlink dialog with the Document page selected, showing Path and Target fields for linking to a specific slide.
...
Visual reference: the Interaction dialog with the Action at mouse click dropdown expanded, listing options like Go to first slide, Go to page or object, Play audio, and Run macro.
