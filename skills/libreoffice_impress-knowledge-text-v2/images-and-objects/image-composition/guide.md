...
Visual reference: examples of rotation mode handles, and the results of rotating, slanting, and skewing images.
...
Visual reference: the Image toolbar with filter, color mode, and transparency controls.
...
Visual reference: three overlapping shapes selected as a group with shared selection handles around them.
