...
_Scope: Header/footer inline editing, dropdown menu (Format, Border, Delete, Insert Page Number/Count), Page Style tabs_
...
_Scope: Page Style dialog Header/Footer tabs (enable, margins, spacing, same content options)_
...
_Scope: Header and Footer submenu to enable/disable per page style_
