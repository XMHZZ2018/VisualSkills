...
The spelling context menu is shown after right-clicking a misspelled word such as "Powrful," which appears highlighted with a wavy red underline at the top of the menu. The menu lists suggested corrections ("Powerful" and "Potful") at the top, followed by **Ignore**, **Ignore All**, **Add to Dictionary**, and **Spelling…** entries, then a separator before **Always correct to** (with a submenu arrow) and **AutoCorrect Options…**, and finally **Set Language for Selection** and **Set Language for Paragraph** at the bottom.
...
The Spelling dialog is titled "Spelling: English (USA)" and has a **Text language** dropdown set to "English (USA)" at the top. Below that is a **Not in dictionary** section containing an editable text pane where the misspelled word "powerxful" appears in red. On the right side of this pane are three buttons: **Ignore Once**, **Ignore All**, and **Add to Dictionary**. The lower half of the dialog shows a **Suggestions** list with "powerful" (highlighted/selected) and "powerless" as alternatives, accompanied by **Correct**, **Correct All**, and **Always Correct** buttons on the right. A **Check grammar** checkbox appears in the lower-left corner, and the bottom button bar contains **Help**, **Options…**, **Undo**, and **Close**.
...
The English Sentence Checking options page displays three groups of checkboxes arranged in two columns. The **Grammar checking** group includes "Possible mistakes," "Word duplication," "Capitalization," and "Parentheses" — all unchecked. The **Punctuation** group lists "Word spacing" (checked), "Quotation marks," "Sentence spacing," "Apostrophe," "More spaces," "Em dash," "Multiplication sign" (checked), "En dash," "Ellipsis," and "Minus sign." The **Others** group at the bottom offers "Convert to metric (°C, km/h, m, kg, l)," "Thousand separation of large numbers," and "Convert to non-metric (°F, mph, ft, lb, gal)" — all unchecked.
