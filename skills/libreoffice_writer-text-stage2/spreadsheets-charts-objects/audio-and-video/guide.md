...
The screenshot shows the Insert menu fully expanded as a vertical dropdown from the Menu bar. It lists all available insertion commands in a single column, starting with Page Break and More Breaks at the top, followed by Image…, Chart…, Media, OLE Object, Shape, Section…, Text from File…, Text Box, Comment, Frame, Fontwork…, and a grayed-out Caption… entry. A separator line divides the upper group from the lower group, which continues with Hyperlink…, Bookmark…, Cross-reference…, Special Character…, Formatting Mark, Horizontal Line, Footnote and Endnote, Table of Contents and Index, Page Number…, Field, Header and Footer, Envelope…, and Signature Line… at the bottom. Several entries — including More Breaks, Media, OLE Object, Shape, Frame, Formatting Mark, Footnote and Endnote, Table of Contents and Index, Field, and Header and Footer — display a right-pointing arrow indicating they open submenus.
