...
The screenshot shows the LibreOffice Writer Insert drop-down menu fully expanded. The menu is a single-column vertical list with items separated into groups by thin horizontal dividers. From top to bottom the entries are: Page Break, More Breaks, Image…, Chart…, Media, OLE Object, Shape, Section…, Text from File…, Text Box, Comment, Frame, Fontwork…, Caption… (grayed out), then after a divider Hyperlink…, Bookmark…, Cross-reference…, then Special Character…, Formatting Mark, then Horizontal Line, Footnote and Endnote, Table of Contents and Index, Page Number…, Field, Header and Footer, Envelope…, and Signature Line…. Some items such as More Breaks, Media, OLE Object, Shape, Frame, Formatting Mark, Footnote and Endnote, Table of Contents and Index, Field, and Header and Footer have a right-pointing arrow indicating a submenu. The menu bar above shows View, Insert (highlighted/selected), Format, Styles, and Table tabs.
