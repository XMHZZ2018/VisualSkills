---
name: aws-iam-roles-policies
description: Configure custom AWS IAM roles and policies in the AWS Console, then attach them to roles and users. Uses computer-use MCP to control the browser.
---
...
```
/mmskills:aws-iam-roles-policies
```
