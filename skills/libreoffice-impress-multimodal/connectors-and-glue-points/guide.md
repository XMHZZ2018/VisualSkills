...
Read the screenshot `figure157.png` in this directory — it shows the Connectors sub-toolbar

Read the screenshot `figure158.png` in this directory — it shows an example of connector glue points

Read the screenshot `figure159.png` in this directory — it shows an example of connectors between objects
...
Read the screenshot `figure160.png` in this directory — it shows the Connector dialog
