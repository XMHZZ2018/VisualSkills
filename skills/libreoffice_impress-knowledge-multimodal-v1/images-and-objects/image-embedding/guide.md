...
Read the screenshot `fig01.png` in this directory — you will see the Insert Image file browser with the Preview and Insert as Link checkboxes visible at the bottom left.
