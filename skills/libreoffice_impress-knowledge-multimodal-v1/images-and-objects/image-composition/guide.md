...
Read the screenshot `fig01.png` in this directory — you will see examples of rotation mode handles, and the results of rotating, slanting, and skewing images.
...
Read the screenshot `fig02.png` in this directory — you will see the Image toolbar with filter, color mode, and transparency controls.
...
Read the screenshot `fig03.png` in this directory — you will see three overlapping shapes selected as a group with shared selection handles around them.
