---
name: libreoffice_writer-knowledge-text-stage1
description: "Practical text-only guides for LibreOffice Writer 7.3.7. Consult via the load_topic MCP tool — it returns the guide text in one atomic call."
---

# LibreOffice Writer 7.3.7 Knowledge (text-v1)
...
> To consult "Numbering Pages", call `load_topic("page-layout-basics/page-numbering")`. You will receive the guide text in a single tool result — no extra `Read` calls needed.
