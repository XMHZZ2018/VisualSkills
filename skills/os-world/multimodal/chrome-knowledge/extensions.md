...
![Extensions page with Developer Mode toggled ON and Load unpacked button visible](./extensions-developer-mode.png)
...
![Extension successfully loaded and displayed on the extensions management page](./extensions-loaded.png)
