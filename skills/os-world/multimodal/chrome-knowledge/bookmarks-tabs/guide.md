...
![Bookmark added dialog showing Name field, Folder dropdown set to Bookmarks Bar, and Done button](./bookmark-added-dialog.png)
...
![Three-dot menu with Bookmarks submenu expanded showing Show Bookmarks Bar option](./bookmark-show-bar-menu.png)
...
![New Folder dialog with name field, location set to Bookmarks Bar, and Save button](./bookmark-folder-dialog.png)
...
![Bookmark folder created on the bookmarks bar with its dropdown showing contained bookmarks](./bookmark-folder-created.png)
...
![Three-dot menu > History showing recently closed tabs and Restore window option](./restore-tab-history-menu.png)
...
![On Startup settings with Continue where you left off option selected](./restore-tab-startup-setting.png)
