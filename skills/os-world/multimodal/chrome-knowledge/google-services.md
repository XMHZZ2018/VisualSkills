...
![Google Flights Explore tab with destination search showing autocomplete suggestions and a map of destinations](./flights-destination-search.png)
...
![Explore view with Filters panel open showing Stops and Duration controls, and map displaying destinations with prices](./flights-explore-filters.png)
...
![Flight search results showing departure times, stops, duration, CO2 emissions, and prices with Cheapest tab](./flights-search-results.png)
