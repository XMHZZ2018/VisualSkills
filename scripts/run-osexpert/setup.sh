...
OSEXPERT_DIR="$MMSKILLS_ROOT/vendor/OSWorld"

# Initialize submodule if not already done
if [ ! -f "$OSEXPERT_DIR/pyproject.toml" ]; then
  echo "Initializing OSExpert-Eval submodule..."
  cd "$MMSKILLS_ROOT"
...
echo ""
echo "Setup complete."
echo "  OSExpert-Eval: $OSEXPERT_DIR"
echo ""
